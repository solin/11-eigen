...
% Since one finite element mesh cannot be optimal for several
...
% \textcolor{red}{Pavel, I changed the previous sentence because one of the method 
% that we are going to describe calls the eigensolver many times and not only on the coarse mesh.}
