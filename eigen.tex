...
\section{Adaptivity Algorithm}\label{sec:adapt}

Before we continue, we need to briefly outline the $hp$-adaptive algorithm \cite{solin3}
that we use in this study. The algorithm uses an idea that is analogous to embedded 
higher-order ODE methods -- it calculates two approximations with different orders of 
